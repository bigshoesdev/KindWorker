...
use app\models\search\Budget as BudgetSearch;
...
class BudgetController extends TController
{
    ...
    protected function findModel($id)
    {
        if (($model = Budget::findOne($id)) !== null) {
            ...
            throw new NotFoundHttpException('The requested Budget does not exist.');
        }
    }
